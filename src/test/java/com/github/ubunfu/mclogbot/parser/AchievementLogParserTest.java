...
public class AchievementLogParserTest {
    ...
    private static final String LOG_VALID = "[01:27:02] [Server thread/INFO]: " + PLAYER + " has made the advancement [" + ACHIEVEMENT + "]";
    ...
    void setUp() {
        ...
        fieldAchievement = new Field("Achievement", ACHIEVEMENT);
    }
